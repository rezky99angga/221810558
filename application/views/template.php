    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url('Home') ?>">BPS Kabupaten Purbalingga
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <?php if ($this->session->userdata('role') == 'ADMIN') : ?>
                            ...
                            <li>
                                <a href="<?= base_url('home/surat_masuk') ?>">
                                    <i class="fa fa-share fa-fw"></i> Surat Masuk
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url('home/surat_keluar') ?>">
                                    <i class="fa fa-reply fa-fw"></i> Surat Keluar
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url('home/surat_keputusan') ?>">
                                    <i class="fa fa-envelope fa-fw"></i> Surat Keputusan
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url('home/pegawai') ?>">
                                    <i class="fa fa-users fa-fw"></i> Pegawai
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url('home/jabatan') ?>">
                                    <i class="fa fa-tasks fa-fw"></i> Jabatan
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url('home/tamu') ?>">
                                    <i class="fa fa-user fa-fw"></i> Daftar Tamu
                                </a>
                            </li>
                        <?php elseif ($this->session->userdata('role') == 'PENGAWAS') : ?>
                            <li>
                                <a href="<?= base_url('home') ?>">
                                    <i class="fa fa-dashboard fa-fw"></i> Dashboard
                                </a>
                        ...
                        <?php elseif ($this->session->userdata('role') == 'KEAMANAN') : ?>
                            <li>
                                <a href="<?= base_url('home') ?>">
                                    <i class="fa fa-dashboard fa-fw"></i> Dashboard
                                </a>
                        ...
                        <?php elseif ($this->session->userdata('role') == 'KOORDINATOR') : ?>
                            <li>
                                <a href="<?= base_url('home') ?>">
                                    <i class="fa fa-dashboard fa-fw"></i> Dashboard
                                </a>
                            ...
                            <li>
                                <a href="<?= base_url('home/disposisi_masuk') ?>">
                                    <i class="fa fa-mail-forward fa-fw"></i> Disposisi Masuk
                                </a>
                            </li>
                            <!-- <li>
                                <a href="<?= base_url('home/disposisi_keluar') ?>">
                                    <i class="fa fa-mail-reply fa-fw"></i> Disposisi Keluar
                                </a>
                            </li> -->
                            <li>
                                <a href="<?= base_url('home/surat_keputusan') ?>">

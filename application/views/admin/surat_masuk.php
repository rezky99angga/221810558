                            ...
                            <?php foreach ($data_surat_masuk as $surat_masuk) : ?>
                                <tr>
                                    ...
                                    <td class="text-center" style="vertical-align: left;">
                                        ...
                                        <button class="btn btn-sm btn-success" data-toggle="modal" data-target="#ubah_surat_masuk" title="Ubah Data" onclick="ubah_surat(<?= $surat_masuk->id_surat ?>)">
                                            <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                                        </button>
                                        <button class="btn btn-sm btn-warning" data-toggle="modal" data-target="#ubah_file_surat_masuk" title="Ubah Surat" onclick="ubah_surat(<?= $surat_masuk->id_surat ?>)">
                                            <span class="glyphicon glyphicon-envelope" aria-hidden="true"></span>
                                        </button>
                                        <a href="<?= base_url('home/disposisi/' . $surat_masuk->id_surat) ?>" title="Disposisi" class="btn btn-sm btn-primary">
                                            <span class="glyphicon glyphicon-transfer" aria-hidden="true"></span>
                                        </a>
                                        <button class="btn btn-sm btn-danger" data-toggle="modal" data-target="#hapus_surat_masuk" title="Hapus Data" onclick="hapus_surat(<?= $surat_masuk->id_surat ?>)">
...
<div class="modal fade" id="hapus_surat_masuk">
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- header-->
            <div class="modal-header">
...
<script>
    function hapus_surat(id_surat) {
        const url = "<?= base_url('home/hapus_surat_masuk/') ?>"

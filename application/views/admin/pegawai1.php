                            ...
                            <?php foreach ($data_pegawai as $pegawai) : ?>
                                <tr>
                                    ...
                                    <td class="text-center" style="vertical-align: left;">
                                        ...
                                        <button class="btn btn-sm btn-danger" title="Hapus" onclick="hapusPegawai(<?= $pegawai->id_pegawai ?>)" data-toggle="modal" data-target="#modal_hapus">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a id="deleteBtn" class="btn btn-danger" data-dismiss="modal">Yakin</a>
            </div>
        </div>
    </div>
</div>
